...
Some CSS properties are more performant than others for animations. Here's a comparison:

### Properties that are harder to animate (more expensive):
- `height`
- `with`
- `background-color`

### Properties that are easier to animate (more performant):
- `transform`
- `opacity`
